...
document.addEventListener('DOMContentLoaded', function(e){
    ...
    //clientEngine.renderer.renderer.resize(600, 800);
    //clientEngine.renderer.renderer.autoResize = true;
    var size = [1920, 1080];
    ...
    function resize() {
        ...
        //clientEngine.renderer.renderer.view.style.width = w + 'px';
        //clientEngine.renderer.renderer.view.style.height = h + 'px';
        //console.log("resize");
        clientEngine.renderer.renderer.autoResize = true;
    }
